...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	wnd_main = CreateWindowEx(0, class_name_main, "Sharpen Tool", WS_OVERLAPPEDWINDOW, 10, 10, 1270, 1000, NULL, NULL, hInstance, NULL);
	wnd_img1 = CreateWindowEx(0, class_name_img1, "Img1", WS_OVERLAPPEDWINDOW | WS_CHILD | WS_VSCROLL | WS_HSCROLL, 50, 50, 800, 600, wnd_main, NULL, hInstance, NULL);
	wnd_crop = CreateWindowEx(0, class_name_crop, "Crop", WS_POPUPWINDOW | WS_CAPTION, 1275, 10, 500, 500, wnd_main, NULL, hInstance, NULL);
	wnd_list = CreateWindowEx(0, class_name_list, "List", WS_POPUPWINDOW | WS_CAPTION, 1275, 510, 500, 500, wnd_main, NULL, hInstance, NULL);
