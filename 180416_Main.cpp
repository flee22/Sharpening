...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	wnd_main = CreateWindow(class_name_main, "Sharpen - Main", WS_OVERLAPPEDWINDOW, 10, 10, 1440, 800, NULL, NULL, hInstance, NULL);
	wnd_crop = CreateWindow(class_name_crop, "Sharpen - Crop", WS_POPUPWINDOW | WS_CAPTION, 1450, 40, 500, 500, NULL, NULL, hInstance, NULL);

	// StatusBar Window
	bar_main = CreateStatusWindow( WS_CHILD | WS_VISIBLE | SBARS_SIZEGRIP, bar_name_main, wnd_main, 9000);
